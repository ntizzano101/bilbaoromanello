				...
				<table class="table">
				  ...
				  <tbody>
					<?php foreach($clientes as $alu){ ?>	
						<tr id="tr<?=$alu->id_cliente?>">
							<td scope="row"><?=$alu->id_cliente ?></td>
							<td><a href="<?php echo base_url(); ?>clientes/cuentacorriente/<?=$alu->id_cliente?>"><?=$alu->nombre ?></a></td>										
							
							<td><?php echo $alu->vendedor ?></td>
							<td><?php echo $fx->moneda($alu->saldo) ?></td>							
							 </td>
						</tr>
					<?php	
					}
