				...
				<table class="table">
				  ...
				  <tbody>
					<?php foreach($clientes as $alu){ ?>						
							<th scope="row"><?=$alu->id_proveedor ?></th>
							<td><a href="<?php echo base_url(); ?>proveedores/cuentacorriente/<?=$alu->id_proveedor?>"><?=$alu->nombre ?></a></td>		<td><?php echo $fx->moneda($alu->saldo) ?></td>			
						</tr>
					<?php	
					}
					?>
